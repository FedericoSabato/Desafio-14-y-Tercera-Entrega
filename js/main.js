    ...
    if(state === "success"){
        ...
        console.log(data);
          ...
          $(".marketPrice2").append(`
            ...
            <h4>${data[298].price}</h4>
          
          `);
          //SOL
          $(".marketPrice3").append(`
          
            <h4>${data[785].price}</h4>
          
          `);
          //SHIBA
          $(".marketPrice4").append(`
          
            <h4>${data[1428].price}</h4>
          
          `);
          //ALPHA
          $(".marketPrice5").append(`
          
            <h4>${data[1092].price}</h4>
          
          `);
          //CAKE
          $(".marketPrice6").append(`
          
            <h4>${data[1295].price}</h4>
          
          `);
          //DOGE
          $(".marketPrice7").append(`
          
            <h4>${data[564].price}</h4>
          
          `);
          //LINK
          $(".marketPrice8").append(`
          
            <h4>${data[436].price}</h4> 
          
          `);
          //ZEN
          $(".marketPrice9").append(`
          
            <h4>${data[850].price}</h4>
...
let btc = new crypto(1,"Bitcoin","BTC",56342.34,1);
